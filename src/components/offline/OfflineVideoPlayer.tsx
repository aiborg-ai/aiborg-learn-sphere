...
export function OfflineVideoPlayer({
  ...
  const loadVideo = useCallback(async () => {
    ...
    try {
      ...
      logger.error('[OfflineVideoPlayer] Failed to load video:', error);
      setState(prev => ({
        ...prev,
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      logger.error('[OfflineVideoPlayer] Download failed:', error);
  ...
  const handleDeleteCache = async () => {
    try {
      ...
      logger.error('[OfflineVideoPlayer] Failed to delete cache:', error);
      toast({
        title: 'Error',
  ...
  const toggleFullscreen = useCallback(async () => {
    ...
    try {
      ...
      logger.error('[OfflineVideoPlayer] Fullscreen error:', error);
    }
  }, []);
