    ...
    <Card className="h-full flex flex-col hover:shadow-lg transition-all duration-300 group">
      ...
      <CardContent className="flex-1 space-y-4">
        ...
        <div className="flex items-start gap-3 text-sm">
          <div className="w-8 h-8 rounded-lg bg-secondary/50 flex items-center justify-center mt-0.5">
            <MapPin className="h-4 w-4 text-secondary-foreground" />
          </div>
          <div className="flex-1">
            <div className="font-medium text-secondary-foreground">{event.location}</div>
          </div>
        </div>
