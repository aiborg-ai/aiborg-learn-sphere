...
export function NovemberVaultCampaignBanner() {
  ...
  const shouldShowBanner =
    isCampaignActive() && hasVaultAccess && !isDismissed && !hasClaimedOffer() && !isLoading;
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-sm text-blue-200/80">
                    * Free for November 2025. Offer valid until November 30, 2025. Regular pricing
                    applies from December onwards.
                  </p>
                </div>
