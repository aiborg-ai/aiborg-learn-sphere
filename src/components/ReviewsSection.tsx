...
export function ReviewsSection({ courseFilter }: { courseFilter?: number }) {
  ...
  logger.log('ReviewsSection render:', {
    reviews,
    loading,
    error,
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener('filterReviewsByCourse', handleCourseFilter as EventListener);
  }, []);
                  ...
                  <CardContent className="flex-1">
                    ...
                    {review.review_type === 'voice' && !review.voice_review_url && (
                      <div className="text-center py-4">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Voice review (file not available)
                        </p>
                      </div>
                    )}
                    ...
                    {review.review_type === 'video' && !review.video_review_url && (
                      <div className="text-center py-4">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Video review (file not available)
                        </p>
                      </div>
                    )}
