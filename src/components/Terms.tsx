export function Terms() {
  return (
    <section
      id="terms"
      className="py-20 bg-gradient-to-br from-background/90 via-background to-background/95"
    >
          ...
          <div className="bg-white/50 backdrop-blur-sm border border-white/20 rounded-lg p-8 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                By accessing and using aiborg's platform and services, you accept and agree to be
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                professional levels, including interactive content, assessments, and certification
                programs.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Course fees are clearly displayed before purchase. Payments are processed securely
                through our payment partners. We offer a 30-day money-back guarantee for all
                courses. Refunds will be processed to the original payment method within 5-10
                business days.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                aiborg or our licensors. Users may access and use the content for personal
                educational purposes only. Redistribution, copying, or commercial use of our content
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Users must not use our platform for any unlawful purpose or in any way that could
                damage, disable, or impair our services. This includes, but is not limited to,
                sharing account credentials, attempting to access unauthorized areas, or interfering
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                GDPR and other applicable privacy laws. Please refer to our Privacy Policy for
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                aiborg shall not be liable for any indirect, incidental, special, consequential, or
                punitive damages resulting from your use of our platform. Our total liability shall
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Either party may terminate the service agreement at any time. We reserve the right
                to suspend or terminate accounts that violate these terms. Upon termination, you
                will lose access to the platform and any associated benefits.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                For questions about these terms or our services, please contact us through our
                support channels. We are committed to resolving any issues promptly and fairly.
              </p>
            </div>
            ...
            <div className="mt-8 p-4 bg-primary/10 rounded-lg border border-primary/20">
              <p className="text-sm text-muted-foreground">
                ...
                resolved through the courts of England and Wales.
              </p>
            </div>
          </div>
        </div>
