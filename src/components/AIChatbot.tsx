...
const initialMessages: Message[] = [
  {
    id: "1",
    content: "Hello! I'm your AI learning assistant. I can help you find the perfect course, answer questions about our programs, or guide you through your learning journey. What would you like to know?",
    sender: "ai",
    timestamp: new Date(),
    type: "text"
  }
