...
export default function LearningPathWizard() {
  ...
  const [learningStyle, setLearningStyle] = useState<'visual' | 'reading' | 'hands-on' | 'mixed'>(
    'mixed'
  );
    ...
    try {
      ...
      if (!assessmentData) {
        toast({
          ...
          description:
            'Please complete an AI assessment first to generate a personalized learning path.',
          variant: 'destructive',
        });
      ...
      if (insightsData) {
        ...
        const cats = insights.map(i => ({
          ...
          icon: insightsData.find(d => d.category_id === i.category_id)?.assessment_categories
            ?.icon,
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <RadioGroup
                  value={targetLevel}
                  onValueChange={v =>
                    setTargetLevel(v as 'beginner' | 'intermediate' | 'advanced' | 'expert')
                  }
                >
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  disabled={focusCategoryIds.length === 0}
                >
          ...
          <Card className="bg-white/10 backdrop-blur-md border-white/20">
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="p-4 bg-white/5 rounded-lg">
                  <div className="text-white/60 text-sm mb-2">
                    Focus Areas ({focusCategoryIds.length})
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {categories
                      .filter(c => focusCategoryIds.includes(c.id))
                      .map(c => (
              ...
              <Alert className="bg-green-500/20 border-green-500/30">
                ...
                <AlertDescription className="text-white/80">
                  Your path will include courses, exercises, {includeWorkshops && 'workshops, '} and
