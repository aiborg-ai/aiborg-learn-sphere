  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]',
  {
    variants: {
      variant: {
        ...
        secondary:
          'bg-secondary text-secondary-foreground shadow-soft hover:bg-secondary/80 hover:shadow-secondary hover:-translate-y-0.5',
        ghost: 'hover:bg-accent/50 hover:text-accent-foreground',
        link: 'text-primary underline-offset-4 hover:underline',
        // New enhanced variants
        hero: 'bg-gradient-to-r from-secondary to-secondary-light text-secondary-foreground font-semibold shadow-secondary hover:shadow-[0_14px_48px_-12px_hsl(18_75%_82%_/_0.5)] hover:scale-[1.02] hover:-translate-y-0.5',
        soft: 'bg-primary/10 text-primary hover:bg-primary/20 hover:shadow-soft',
        'ghost-border':
