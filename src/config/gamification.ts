...
export const GAMIFICATION_CONFIG = {
  ...
  BADGES: {
    ...
    ASSESSMENT_BRONZE: {
      id: 'assessment_bronze',
      name: 'Bronze Achiever',
      icon: '🥉',
      description: 'Scored 60%+ on an assessment',
      category: 'achievement',
      rarity: 'common',
      points: 75,
      criteria: { assessment_score_60: 1 },
    },
    ASSESSMENT_SILVER: {
      id: 'assessment_silver',
      name: 'Silver Scholar',
      icon: '🥈',
      description: 'Scored 75%+ on an assessment',
      category: 'achievement',
      rarity: 'rare',
      points: 100,
      criteria: { assessment_score_75: 1 },
    },
    ASSESSMENT_GOLD: {
      id: 'assessment_gold',
      name: 'Gold Master',
      ...
      rarity: 'epic',
      points: 150,
      criteria: { assessment_score_90: 1 },
    },
    ASSESSMENT_PLATINUM: {
      id: 'assessment_platinum',
      ...
      rarity: 'legendary',
      points: 250,
      criteria: { assessment_score_95: 1 },
    },
    ASSESSMENT_PERFECT: {
      ...
      rarity: 'legendary',
      points: 500,
      criteria: { assessment_score_100: 1 },
    },
    AI_AWARENESS_CERTIFIED: {
      id: 'ai_awareness_certified',
      name: 'AI Awareness Certified',
      icon: '🎯',
      description: 'Passed the AI Awareness Assessment',
      category: 'achievement',
      rarity: 'rare',
      points: 200,
      criteria: { ai_awareness_passed: 1 },
    },
    AI_FLUENCY_CERTIFIED: {
      id: 'ai_fluency_certified',
      name: 'AI Fluency Certified',
      icon: '⚡',
      description: 'Passed the AI Fluency Assessment',
      category: 'achievement',
      rarity: 'epic',
      points: 300,
      criteria: { ai_fluency_passed: 1 },
    },
    ASSESSMENT_STREAK_3: {
      id: 'assessment_streak_3',
      ...
      rarity: 'rare',
      points: 150,
      criteria: { assessments_completed: 3 },
    },
    TOP_PERCENTILE: {
      id: 'top_percentile',
      name: 'Top Performer',
      icon: '🏆',
      description: 'Scored in the top 10% of all users',
      category: 'achievement',
      rarity: 'legendary',
      points: 400,
      criteria: { top_10_percentile: 1 },
    },
  } as const,
