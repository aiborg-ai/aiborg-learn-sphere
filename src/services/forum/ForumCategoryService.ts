...
export class ForumCategoryService {
  ...
  static async getCategories(): Promise<ForumCategory[]> {
    try {
      ...
      logger.error('Error fetching forum categories:', _error);
      throw _error;
    }
  }
  ...
  static async getCategoriesWithStats(): Promise<ForumCategoryWithStats[]> {
    try {
      ...
      logger.error('Error fetching categories with stats:', _error);
      throw _error;
    }
  }
  ...
  static async getCategoryBySlug(slug: string): Promise<ForumCategory | null> {
    try {
      ...
      logger.error('Error fetching category by slug:', _error);
      throw _error;
    }
  }
  ...
  static async getCategoryById(id: string): Promise<ForumCategory | null> {
    try {
      ...
      logger.error('Error fetching category by ID:', _error);
      throw _error;
    }
  }
  ...
  static async getCategoryStats(categoryId: string): Promise<CategoryStats | null> {
    try {
      ...
      logger.error('Error fetching category stats:', _error);
      throw _error;
    }
  }
  ...
  static async getPopularCategories(limit: number = 6): Promise<ForumCategory[]> {
    try {
      ...
      logger.error('Error fetching popular categories:', _error);
      throw _error;
    }
  }
  ...
  static async updateCategory(
    ...
    try {
      ...
      logger.error('Error updating category:', _error);
      throw _error;
    }
  }
  ...
  static async deleteCategory(categoryId: string): Promise<void> {
    try {
      ...
      logger.error('Error deleting category:', _error);
      throw _error;
    }
  }
  ...
  static async reorderCategories(orderedIds: string[]): Promise<void> {
    try {
      ...
      logger.error('Error reordering categories:', _error);
      throw _error;
    }
  }
  ...
  static async getCategoryCount(): Promise<number> {
    try {
      ...
      logger.error('Error getting category count:', _error);
      return 0;
    }
  }
}
