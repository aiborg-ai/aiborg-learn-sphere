-- SQL Script to CREATE NEW blog posts - Simple version
-- Run this in your Supabase SQL Editor

-- Temporarily disable RLS
ALTER TABLE blog_posts DISABLE ROW LEVEL SECURITY;

-- Insert 5 NEW blog posts using subqueries for author and category
...
SELECT
  'Created ' || COUNT(*) || ' new blog posts' as result,
  STRING_AGG(title, ', ') as new_posts
FROM blog_posts
WHERE slug IN (
  'ai-voice-cloning-ethics',
  'quantum-computing-encryption-threat',
