...
// You need to provide the password for the user
const USER_EMAIL = 'hirendra@gmail.com';
const USER_PASSWORD = process.env.USER_PASSWORD || 'your-password-here'; // Replace with actual password
...
async function insertBlogPostWithAuth() {
  try {
    console.log('🔐 Attempting to sign in as:', USER_EMAIL);

    if (USER_PASSWORD === 'your-password-here') {
      console.log('\n⚠️ Please provide the actual password for the user.');
      console.log('You can either:');
      console.log('1. Edit this script and replace "your-password-here" with the actual password');
      console.log('2. Set the USER_PASSWORD environment variable');
      console.log('3. Use the browser console method instead (recommended for security)');
      console.log('\n📝 Browser method:');
      console.log('1. Go to http://localhost:8081/');
      console.log('2. Log in with your credentials');
      console.log('3. Open browser console (F12)');
      console.log('4. Copy and paste contents of scripts/browser-insert-blog.js');
    ...
    console.log('📱 The post is now visible to you when logged in as', USER_EMAIL);
    ...
    console.log('https://aiborg-ai-web.vercel.app/blog/' + data.slug);
...
// Run the insertion
console.log('🚀 Starting authenticated blog post insertion...\n');
insertBlogPostWithAuth();