...
-- Insert sample approved reviews without needing profile relationships
...
(gen_random_uuid(), 1, 'show_name', 'written', 'This AI fundamentals course exceeded my expectations! The instructors were knowledgeable and the hands-on projects really helped solidify the concepts. I feel much more confident about implementing AI solutions in my work now.', 'January 2024', 'online', 5, true),
...
(gen_random_uuid(), 1, 'show_name', 'written', 'Absolutely fantastic! The course transformed my understanding of AI and its practical applications. The instructors were patient and always available for questions. The networking opportunities were an added bonus.', 'November 2023', 'hybrid', 5, true),
...
(gen_random_uuid(), 2, 'show_name', 'written', 'This course gave me the confidence to transition my career into AI. The support from instructors and fellow students was amazing. The curriculum is up-to-date with industry standards and trends.', 'September 2023', 'in-person', 5, true);