...
-- Create corrected admin policies using the security definer function
...
-- Insert sample approved reviews with correct display_name_option values
...
(gen_random_uuid(), 1, 'full_name', 'written', 'This AI fundamentals course exceeded my expectations! The instructors were knowledgeable and the hands-on projects really helped solidify the concepts. I feel much more confident about implementing AI solutions in my work now.', 'January 2024', 'online', 5, true),
(gen_random_uuid(), 2, 'anonymous', 'written', 'Great course content and well-structured curriculum. The machine learning modules were particularly insightful. However, I would have liked more real-world case studies. Overall, a solid learning experience.', 'December 2023', 'in-person', 4, true),
(gen_random_uuid(), 1, 'full_name', 'written', 'Absolutely fantastic! The course transformed my understanding of AI and its practical applications. The instructors were patient and always available for questions. The networking opportunities were an added bonus.', 'November 2023', 'hybrid', 5, true),
(gen_random_uuid(), 3, 'anonymous', 'written', 'The deep learning course was challenging but rewarding. The labs were excellent and the theoretical foundation was solid. I appreciate the practical approach to complex topics. Highly recommended for serious learners.', 'October 2023', 'online', 4, true),
(gen_random_uuid(), 2, 'full_name', 'written', 'This course gave me the confidence to transition my career into AI. The support from instructors and fellow students was amazing. The curriculum is up-to-date with industry standards and trends.', 'September 2023', 'in-person', 5, true);