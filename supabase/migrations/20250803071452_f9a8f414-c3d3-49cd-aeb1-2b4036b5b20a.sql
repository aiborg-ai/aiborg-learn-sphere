...
-- SMEs courses (100 new)
INSERT INTO courses (title, description, audience, mode, duration, price, level, start_date, features, category, keywords, prerequisites, sort_order) VALUES
('AI Business Strategy Workshop', 'Develop comprehensive AI strategy for your organization', 'SMEs', 'Hybrid', '16 hrs/8 sessions', '£300', 'Executive', '22 Aug 2025', '{"Strategic planning", "Competitive advantage", "ROI analysis", "Implementation roadmap"}', 'Strategy', '{"strategy", "planning", "business"}', 'Senior management experience', 4001),
...
('AI Innovation Lab Setup', 'Establish and manage AI innovation centers', 'SMEs', 'Hybrid', '18 hrs/9 sessions', '£350', 'Executive', '19 Sep 2025', '{"Innovation management", "R&D strategies", "Technology adoption", "Change leadership"}', 'Innovation', '{"innovation", "R&D", "technology"}', 'Innovation leadership experience', 4005),
('AI Merger & Acquisition Due Diligence', 'Evaluate AI capabilities in M&A scenarios', 'SMEs', 'Online', '10 hrs/5 sessions', '£400', 'Executive', '26 Sep 2025', '{"Due diligence", "Technology assessment", "Integration planning", "Value estimation"}', 'M&A', '{"merger", "acquisition", "valuation"}', 'M&A experience', 4006),
('AI Workforce Transformation', 'Lead organization-wide AI adoption and training', 'SMEs', 'Hybrid', '20 hrs/10 sessions', '£380', 'Executive', '3 Oct 2025', '{"Change management", "Workforce planning", "Skills development", "Cultural transformation"}', 'Workforce', '{"workforce", "transformation", "change"}', 'HR leadership experience', 4007),
...
('AI Investment & Funding Strategy', 'Secure funding and investment for AI initiatives', 'SMEs', 'Hybrid', '14 hrs/7 sessions', '£340', 'Executive', '24 Oct 2025', '{"Investment strategy", "Funding sources", "Pitch development", "Investor relations"}', 'Investment', '{"investment", "funding", "strategy"}', 'Finance leadership experience', 4010);
...
SELECT 
    ...
    (ARRAY['Advanced', 'Executive'])[floor(random() * 2 + 1)],
    (current_date + interval '1 week' * generate_series)::text,
