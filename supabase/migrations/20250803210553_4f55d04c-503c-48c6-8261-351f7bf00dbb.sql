...
-- Create profiles for sample review users first
...
-- Insert sample reviews (using approved instead of is_approved to match schema)
...
('00000000-0000-0000-0000-000000000004', 3, 'anonymous', 'written', 'The deep learning course was challenging but rewarding. The labs were excellent and the theoretical foundation was solid. I appreciate the practical approach to complex topics. Highly recommended for serious learners.', 'October 2023', 'online', 4, true),
