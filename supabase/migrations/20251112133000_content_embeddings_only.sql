-- Migration: Content Embeddings Table Only
-- This migration adds ONLY the content_embeddings table for Ollama (768 dimensions)
-- Run this if the other AI recommendation tables already exist

-- Enable pgvector extension for vector similarity search
CREATE EXTENSION IF NOT EXISTS vector;

-- ============================================================================
-- Content Embeddings Table (768 dimensions for Ollama nomic-embed-text)
-- ============================================================================
...
COMMENT ON TABLE public.content_embeddings IS 'Vector embeddings for content similarity search and recommendations (768 dims - Ollama)';
...
DROP POLICY IF EXISTS "Anyone can view content embeddings" ON public.content_embeddings;
