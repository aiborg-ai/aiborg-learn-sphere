-- Original Knowledgebase Seed Data
-- AI Pioneers, Events, and Research
...
(
  'Andrej Karpathy',
  'andrej-karpathy',
  'Former Director of AI at Tesla and founding member of OpenAI, Andrej Karpathy is known for his work on deep learning and AI education.',
  '## Background

Andrej Karpathy was born in Slovakia and moved to Canada at age 15. He received his PhD from Stanford under Fei-Fei Li, working on computer vision.

## Career

### OpenAI
Karpathy was a founding member of OpenAI in 2015, working on deep learning research and generative models.

### Tesla
As Director of AI, he led the Autopilot computer vision team, developing neural networks for self-driving cars.

### Return to OpenAI
In 2023, Karpathy returned to OpenAI to work on AGI research.

## Education

Karpathy is renowned for his educational content:
- Created CS231n at Stanford
- Popular YouTube channel on AI
- Neural Networks: Zero to Hero course

## Philosophy

Known for advocating practical, hands-on learning and making complex AI concepts accessible.',
  'pioneers',
  'published',
  true,
  5,
  ARRAY['Tesla', 'OpenAI', 'computer vision', 'AI education'],
  '{"specialty": "Computer Vision & Autonomous Driving", "country": "Slovakia/USA", "birth_year": 1986, "affiliations": ["OpenAI", "Tesla", "Stanford"], "awards": ["MIT Technology Review 35 Under 35"]}'::jsonb
),
...
(
  'Ilya Sutskever',
  'ilya-sutskever',
  'Co-founder of OpenAI and Safe Superintelligence Inc., Ilya Sutskever is one of the most influential researchers in deep learning.',
  '## Background

Ilya Sutskever was born in Russia and immigrated to Israel at age 5, later moving to Canada. He completed his PhD under Geoffrey Hinton at the University of Toronto.

## Key Contributions

### AlexNet
Co-authored the AlexNet paper that revolutionized computer vision and sparked the deep learning era.

### Sequence-to-Sequence Learning
Pioneered seq2seq models that became foundational for machine translation and NLP.

### OpenAI
As Chief Scientist, led research that produced GPT series and helped establish OpenAI as a leading AI lab.

## Safe Superintelligence Inc.

In 2024, Sutskever founded SSI with the mission of building safe superintelligent AI as the singular focus.

## Philosophy

Known for his focus on AI safety and belief that superintelligence will be the most important technology ever created.',
  'pioneers',
  'published',
  true,
  6,
  ARRAY['OpenAI', 'AlexNet', 'deep learning', 'AI safety'],
  '{"specialty": "Deep Learning & AI Safety", "country": "Russia/Canada/USA", "birth_year": 1985, "affiliations": ["Safe Superintelligence Inc.", "OpenAI", "Google Brain"], "awards": ["NeurIPS Test of Time Award", "MIT Technology Review 35 Under 35"]}'::jsonb
)
...
(
  ...
  'cvpr',
  'The premier annual conference on computer vision, featuring cutting-edge research in image and video understanding.',
  '## About CVPR

The IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR) is the premier annual computer vision event.
...
CVPR papers have introduced many breakthrough techniques including ResNet, YOLO, and Vision Transformers.',
  'events',
  'published',
  true,
  4,
  ARRAY['computer vision', 'conference', 'IEEE', 'research'],
  '{"start_date": "2025-06-14", "end_date": "2025-06-20", "location": "Nashville, USA", "venue": "Music City Center", "website": "https://cvpr.thecvf.com", "is_virtual": false}'::jsonb
)
...
"We propose a new simple network architecture, the Transformer, based solely on attention mechanisms, dispensing with recurrence and convolutions entirely."',
  ...
  '{"authors": ["Ashish Vaswani", "Noam Shazeer", "Niki Parmar", "Jakob Uszkoreit", "Llion Jones", "Aidan N. Gomez", "Łukasz Kaiser", "Illia Polosukhin"], "publication_date": "2017-06-12", "journal": "NeurIPS 2017", "doi": "10.48550/arXiv.1706.03762", "citations": 120000}'::jsonb
),
...
The techniques introduced in AlexNet—ReLU, dropout, data augmentation, GPU training—became standard practice in deep learning.',
  ...
  '{"authors": ["Alex Krizhevsky", "Ilya Sutskever", "Geoffrey E. Hinton"], "publication_date": "2012-12-03", "journal": "NeurIPS 2012", "doi": "10.1145/3065386", "citations": 120000}'::jsonb
),
...
BERT spawned a family of models including RoBERTa, ALBERT, DistilBERT, and many others. The pre-train and fine-tune paradigm it established remains central to NLP today.',
  ...
  '{"authors": ["Jacob Devlin", "Ming-Wei Chang", "Kenton Lee", "Kristina Toutanova"], "publication_date": "2018-10-11", "journal": "NAACL 2019", "doi": "10.48550/arXiv.1810.04805", "citations": 90000}'::jsonb
),

(
  'GPT-3: Language Models are Few-Shot Learners',
  'gpt3-few-shot-learners',
  'OpenAI''s GPT-3 demonstrated that scaling language models leads to emergent few-shot learning capabilities.',
  '## Overview

GPT-3, published by OpenAI in 2020, demonstrated that large language models can perform tasks with few or no examples, fundamentally changing expectations for AI capabilities.

## Key Findings

### Scale
GPT-3 uses 175 billion parameters, orders of magnitude larger than previous models.

### Few-Shot Learning
The model can perform tasks given just a few examples in the prompt, without fine-tuning.

### Emergent Abilities
Capabilities emerged at scale that were not present in smaller models.

## Impact

GPT-3 launched the era of large language models and inspired ChatGPT, GPT-4, and the current AI revolution.',
  'research',
  'published',
  true,
  4,
  ARRAY['GPT-3', 'LLM', 'few-shot learning', 'OpenAI'],
  '{"authors": ["Tom Brown", "Benjamin Mann", "Nick Ryder", "et al."], "publication_date": "2020-05-28", "journal": "NeurIPS 2020", "citations": 25000}'::jsonb
),

(
  'Deep Residual Learning (ResNet)',
  'deep-residual-learning-resnet',
  'Microsoft Research''s ResNet introduced skip connections enabling training of very deep neural networks.',
  '## Overview

ResNet, published in 2015, solved the degradation problem in deep networks through residual learning with skip connections.

## Key Innovation

### Skip Connections
Instead of learning the desired mapping directly, residual blocks learn the residual (difference) with skip connections.

### Very Deep Networks
Enabled training of networks with 100+ layers, winning ImageNet 2015 with 152 layers.

## Impact

ResNet is one of the most cited papers in deep learning and residual connections are now ubiquitous in neural network architectures.',
  'research',
  'published',
  true,
  5,
  ARRAY['ResNet', 'CNN', 'skip connections', 'ImageNet'],
  '{"authors": ["Kaiming He", "Xiangyu Zhang", "Shaoqing Ren", "Jian Sun"], "publication_date": "2015-12-10", "journal": "CVPR 2016", "citations": 180000}'::jsonb
)
